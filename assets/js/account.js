...
function　getQR(code,account){
  ...
  if(data != null){
    if(money == 0 || money == "NaN"){
      url = `https://quickchart.io/qr?text=TWQRP%3A%2F%2F${code}NTTransfer%2F158%2F02%2FV1%3FD6%3D${account}%26D5%3D${code}%26D10%3D901&size=400`;
    }
    else{
      url = `https://quickchart.io/qr?text=TWQRP%3A%2F%2F${code}NTTransfer%2F158%2F02%2FV1%3FD6%3D${account}%26D5%3D${code}%26D1%3D${money*100}%26D10%3D901&size=400`;
    }
    console.log(url);
    open(url,"_block");
  }
